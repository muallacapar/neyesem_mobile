...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Ekran açıldığında verileri otomatik yüklemesi için BlocProvider ile sarmalıyoruz
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        body: BlocBuilder<ProfileBloc, ProfileState>(
          builder: (context, state) {
            // DURUM 1: VERİLER YÜKLENİYORSA (Senin güncellediğin const yapısına uygun)
            ...
            // DURUM 2: VERİLER BAŞARIYLA YÜKLENDİYSE (Loaded)
                      ...
                      child: Wrap(
                        ...
                        children: _dietOptions.map((diet) {
                          ...
                          return ChoiceChip(
                            label: Text(diet),
                            selected: isSelected,
                            selectedColor: AppColors.healthGreen.withOpacity(
                              0.2,
                            ),
                            ...
                            onSelected: (selected) {
                              if (selected) {
                                // Güncel Event yapısına tetikleme gönderiyoruz
                      ...
                      child: Wrap(
                        ...
                        children: _allergyOptions.map((allergy) {
                          ...
                          return FilterChip(
                            ...
                            onSelected: (selected) {
                              // Mevcut listenin güvenli bir kopyasını oluşturuyoruz
                              ...
                              // Güncellenmiş listeyi Event ile BLoC'a iletiyoruz
                              context.read<ProfileBloc>().add(
